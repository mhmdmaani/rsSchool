...
<div class="container">
    ...
    <div class="borderedContainer">
        ...
        <!-- end search btn -->
        <div class="addBtnContainer">
            <button type="button" class="btn btn-primary"  onclick="displayStudentsList()" >New Student</button>
        </div>
        <div class="row">
...
<div id="teacherForm"  >
    <div class="formContentContainer">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="teacherFormTitle">New Student</h5>
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="nameId" class="col-form-label">Name:</label>
                    <input type="text" name="name" class="form-control" id="teacherNameId">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="imageId" class="col-form-label">image:</label>
                    <input type="text" name="image" class="form-control" id="teacherImageId">
                </div>

            </div>
            <div class="modal-footer">
                <button type="button" onclick="hideStudentForm()" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="button"  id="formTeacherBtn" class="btn btn-primary">Create</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="formContentContainer">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button"  id="formStudentBtn" onclick="onAddDegree()" class="btn btn-primary">Create</button>
            </div>
        </div>
    </div>
</div>
